...
util.log.debug('router: req.url: '+req.url+' -> '+route.handlerName+'()');
...
util.log.debug('xrest.Router: mount: app['+route.method.toLowerCase()+']('+path+', middleware, fn);');
...
// .htm     html    text/html
// .html    html    text/html
// .xml     xml     application/xml     -- problematic, as FF prefers this oer HTML/XHTML
// .txt     txt     text/plain
